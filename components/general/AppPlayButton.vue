<template>
  <div class="rounded-full h-14 w-14 border-2 flex justify-center items-center transition-all duration-300 bg-white/15 border-white inline-block mb-4 hover:hover:bg-white/60">
    <svg class="ml-1" width="25px" height="25px" viewBox="-0.5 0 7 7" xmlns="http://www.w3.org/2000/svg">
